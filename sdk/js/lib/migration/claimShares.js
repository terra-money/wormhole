        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    ...
                    approvalIx = Token.createApproveInstruction(TOKEN_PROGRAM_ID, new PublicKey(lp_share_token_account), new PublicKey(authority_address(program_id)), new PublicKey(payerAddress), [], Number(amount));

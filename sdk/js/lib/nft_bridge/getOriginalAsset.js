...
export function getOriginalAssetSol(connection, tokenBridgeAddress, mintAddress) {
    return __awaiter(this, void 0, void 0, function () {
        var _a, parse_wrapped_meta, wrapped_meta_address, wrappedMetaAddress, wrappedMetaAddressPK, wrappedMetaAccountInfo, parsed, token_id_arr, token_id;
            ...
            switch (_b.label) {
                ...
                case 2:
                    ...
                    if (wrappedMetaAccountInfo) {
                        ...
                        token_id = BigNumber.from(token_id_arr.reverse()).toString();
                        return [2 /*return*/, {
                                isWrapped: true,
